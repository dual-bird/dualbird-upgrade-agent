...
from pyspark.sql.functions import row_number, rank, dense_rank, sum, avg, col
...
cumulative = Window.partitionBy("region").orderBy("date").rowsBetween(Window.unboundedPreceding, Window.currentRow)
